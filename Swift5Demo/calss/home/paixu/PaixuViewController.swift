//
//  PaixuViewController.swift
//  Swift5Demo
//
//  Created by 阿永 on 2021/3/10.
...
class PaixuViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        btn.frame = CGRect.init(x: 20, y: 100, width: 100, height: 40)
        btn.center = CGPoint.init(x: screenWith*0.5, y: 40)
        btn.setTitleColor(UIColor.white, for: .normal)
        btn.addTarget(self, action: #selector(showView), for: .touchUpInside)
        view.addSubview(btn)
    ...
    @objc func showView() {
        ...
        let actionVC = UIAlertController.init(title: "排序方式", message: nil, preferredStyle: UIAlertController.Style.actionSheet)
